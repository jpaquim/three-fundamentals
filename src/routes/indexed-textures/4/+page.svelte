<script lang="ts">
	...
	function main() {
		...
		function get255BasedColor(color: string): [number, number, number, number] {
			tempColor.set(color);
		...
		function setPaletteColor(index: number, color: [number, number, number, number]) {
		...
		function recordStartTimeAndPosition(event: MouseEvent) {
